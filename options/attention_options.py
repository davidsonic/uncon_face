...
class AttenOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='style_split_two_side_train_fix_flip_2_2_vgg_sim5_attention',help='name of the experiment.')
        # self.parser.add_argument('--name', type=str, default='style2style_two_side_train_fix_flip_2_2_vgg_sim5',help='name of the experiment.')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default='/home/jiali/program/uncon_face/checkpoints', help='models are saved here')
        ...
        # self.parser.add_argument('--dataroot', type=str,
        #                          default='/home/jiali/program/uncon_face/datasets/datasets/train')  # important!
        ...
        self.parser.add_argument('--n_downsample_global', type=int, default=3,
                                 help='number of downsampling layers in netG')
        self.parser.add_argument('--n_blocks_global', type=int, default=6,
