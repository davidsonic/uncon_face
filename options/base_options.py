...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='wacv_photo2photo_5l1', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--gpu_ids', type=str, default='3', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default='wacv_checkpoints', help='models are saved here')
        self.parser.add_argument('--norm', type=str, default='instance', help='instance normalization or batch normalization')        
        self.parser.add_argument('--use_dropout', action='store_true', help='use dropout for the generator')

        # input/output sizes
        # set false to use_encoding, two side uses encoding direction
        ...
        # for setting inputs
        # self.parser.add_argument('--dataroot', type=str, default='/home/jiali/program/tmp/Rafd_category')  # important!
        # self.parser.add_argument('--dataroot', type=str, default='/mnt/jiali/data/icv/crop_resize')  # important!
        self.parser.add_argument('--dataroot', type=str, default='/home/jiali/program/uncon_face/datasets/datasets/train')  # important!
        # self.parser.add_argument('--dataroot', type=str, default='/home/jiali/program/tmp/DeepFashion')  # important!
        ...
        #  dimension of encoded feature
        self.parser.add_argument('--feat_num', type=int, default=1, help='dimension for encoded features')
        self.parser.add_argument('--load_features', action='store_true', help='if specified, load precomputed feature maps')
        self.parser.add_argument('--n_downsample_E', type=int, default=6, help='# of downsampling layers in encoder')
        ...
        # disentanglement of FG and BG, set false to use
