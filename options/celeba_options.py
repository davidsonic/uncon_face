...
class CelebaOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='10_oneside_fix_flip_5xl1_vgg', help='name of the experiment. It decides where to store samples and models')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='/home/jiali/program/uncon_face/datasets/celeb_hq_ids')  # important!
