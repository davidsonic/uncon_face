...
class FashionOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='fashion_one_side_train_fix_flip_5xl1_vgg_discon_18', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--use_fashion', action='store_false', help='use deep fashion dataset')
